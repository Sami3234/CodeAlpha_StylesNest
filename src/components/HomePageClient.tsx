    ...
    <div className="flex min-h-screen min-w-0 flex-col overflow-x-clip" style={{ backgroundColor: '#f5f5f5' }}>
        ...
        >
          ...
          >
            ...
            {(() => {
              ...
              const displayItems = validImages.map((image, index) => ({ image, index }));
              if (displayItems.length === 0) {
                return (
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>Explore our latest garments on the shop.</p>
                    <Link
                      href="/shop?category=clothes"
                      style={{
                        display: 'inline-block',
      ...
      >
        ...
        >
          ...
          <ElectronicsProductCarousel images={electronicsImages} />
