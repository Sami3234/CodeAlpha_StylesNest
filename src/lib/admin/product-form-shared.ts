...
export const adminProductTranslations: Record<string, string> = {
  ...
  'admin.form.deliveryCharge': 'Delivery charge (PKR)',
  'admin.form.deliveryChargeDesc': 'Required when free delivery is off — added once per product at checkout',
  'admin.form.deliveryChargeRequired': 'Enter delivery charge when free delivery is disabled',
